...
<div class="main-header">
    ...
    <p>Tác giả: Nguyên Thúy Nga - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0858 481 597</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 Nguyên Thúy Nga - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0858 481 597</div>", unsafe_allow_html=True)
